...
namespace DS.RevitCmd.EnergyTest
{
    internal class EnergyModelFactory : IEnergyModelFactory
    {
        ...
        public EnergyModelFactory(
            ...
            EnergySurfaceFactory energySurfaceFactory)
        {
            _doc = activeDoc;
            _links = links;
        ...
        private IEnumerable<(Curve, Element)> GetGraphAnalyticalBoundary(IList<IList<BoundarySegment>> segmentLists, Transform transform)
        {
